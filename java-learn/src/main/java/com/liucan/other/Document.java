...
public class Document {
     ...
     *
     *  1.不能说的太细了，如mq保证消息不丢失，等他说完了
     *  2.答的不够好，redis，pipeline需要主要的地方，上一个命令不能依赖于下个命令
     *  3.建索引，哪些索引如何建索引？，查询的时候，分析where，order by，join，里面是否要建索引，像枚举就没必要键索引
     *  4.查询优化，
     *  5.sync锁，不能主动结束
     *  6.redis key分片，通过use_id来判断
     *  7.生产环境上面，出现问题？如何解决？-先定位问题，再如何解决问题
     *  8.同步和异步，--引导面试官朝你熟悉的地方？如线程池，一般我们里面用的线程池？
     *  9.记得，记得，记得，一定要记得引导面试官朝你熟悉的地方，可以一步一步的引过去---------很重要，
     *  10.dubbo写到简历上面，spring cloud经验没得
     *  11.购物车，用户中心那块去问问？
     *
     *  12.问下前端打点问题
     *  dubbo
